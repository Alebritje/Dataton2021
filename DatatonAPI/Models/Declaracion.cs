...
namespace DatatonAPI.Models
{
    ...
    public partial class BienInmueble
    {
        ...
        public Guid DatoIdentificacion { get; set; }
    ...
    public enum Moneda { Mxn };

    public partial class Declaracion
    {
        public static List<Declaracion> FromJson(string json) => JsonConvert.DeserializeObject<List<Declaracion>>(json, DatatonAPI.Models.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this List<Declaracion> self) => JsonConvert.SerializeObject(self, DatatonAPI.Models.Converter.Settings);
    }
    ...
    internal static class Converter
    {
        public static readonly JsonSerializerSettings Settings = new JsonSerializerSettings
        {
            ...
            Converters =
            {
                MonedaConverter.Singleton,
                new IsoDateTimeConverter { DateTimeStyles = DateTimeStyles.AssumeUniversal }
            },
        };
    }

    internal class MonedaConverter : JsonConverter
    {
        public override bool CanConvert(Type t) => t == typeof(Moneda) || t == typeof(Moneda?);
        ...
        public override object ReadJson(JsonReader reader, Type t, object existingValue, JsonSerializer serializer)
        {
            ...
            throw new Exception("Cannot unmarshal type Moneda");
        }
        ...
        public override void WriteJson(JsonWriter writer, object untypedValue, JsonSerializer serializer)
        {
            ...
            var value = (Moneda)untypedValue;
            if (value == Moneda.Mxn)
            {
                serializer.Serialize(writer, "MXN");
                return;
            }
            throw new Exception("Cannot marshal type Moneda");
        }

        public static readonly MonedaConverter Singleton = new MonedaConverter();
    }
